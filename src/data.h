...
#define PASTEBIN_SUBMIT_URL "https://pastebin.com/api/api_post.php"
#define PASTEBIN_USERCODE_URL "https://pastebin.com/api/api_login.php"
...
#define MANPAGE_SHORT "\n"\
	"Pastebincl is a software designed to submit pastes on https://pastebin.com/ using the command-line. To see the full manpage, type \"man pastebincl\" (UNIX-like OS).\n"\
	"\n"\
	"Arguments:\n"\
	" -v, --version \n"\
